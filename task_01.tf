...
resource "null_resource" "null2"  {
 provisioner "local-exec" {
   command = "git clone https://github.com/aakash1003/my_images.git D:/projects/code"
}
}
...
provisioner "remote-exec" {
    inline = [
      ...
      "sudo git clone https://github.com/aakash1003/my_images.git /var/www/html/",
...
provisioner "local-exec"{
 command  =   "rd /s /q D:/projects/code"
}
